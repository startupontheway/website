...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      "A flexible structure with the protection of limited liability — ideal for service-led founding teams.",
    process: [
      "Name approval",
      "DPIN allotment",
  ...
  },
  {
    ...
    description:
      "Stay compliant with the Companies Act — we handle annual returns, board resolutions, and statutory registers.",
    process: [
      "Compliance calendar",
      "Board minutes",
      "Annual return",
  ...
  },
  {
    ...
    description:
      "Unlock tax exemptions, IPR fast-tracks, and government tenders with DPIIT recognition.",
    process: [
      "Eligibility check",
      "Pitch deck prep",
      "DPIIT application",
  ...
  },
  {
    ...
    description:
      "Founder-friendly accounting that scales — monthly books, GST returns, and tax planning.",
  ...
  },
  {
    ...
    description:
      "Production-ready contracts drafted by lawyers — founders' agreements, NDAs, employment, vendor contracts.",
    process: [
      "Requirement intake",
      "Drafting",
      "Review cycles",
